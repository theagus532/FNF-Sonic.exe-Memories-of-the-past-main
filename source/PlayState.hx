	...
	override public function create()
	{
		...
		switch (curStage)
		{
			case 'too-slow': // somncic!!!!
				...
				deadtailz = new FlxSprite(0, 0).loadGraphic(Paths.image("PolishedP1/DeadTailz"));
				deadtailz.frames = Paths.getSparrowAtlas('DeadTailz');
				deadtailz.animation.addByPrefix('dead', "DeadTailz Tails Spike Animated instance", 24);
				deadtailz.animation.play('dead');
				add(deadtailz);
			...
			case 'fuckles':
				//HOLY FUCKLES ITS KNUCKLES
				//also read softlocked by jesterfrog
				//https://mspfa.com/?s=37540&p=1
				//anyways its chucklefuck time
